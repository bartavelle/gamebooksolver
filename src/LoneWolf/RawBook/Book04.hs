module LoneWolf.RawBook.Book04 where
...
chapters =
  [ ( 1,
      Chapter
        ...
        (Decisions [("If you wish to investigate the hut, turn to 160.", NoDecision (Goto 160)), ("If you wish to ignore the hut and continue on your ride along the Ruanon Pike, turn to 273.", NoDecision (Goto 273))])
    ),
    ( 2,
      Chapter
        "2"
        ...
        (CanTake Backpack 1 (CanTake Gold 12 (CanTake Meal 2 (CanTake (Weapon Sword) 1 (CanTake (Weapon Mace) 1 (CanTake (Weapon Dagger) 1 (CanTake (Weapon Warhammer) 1 (NoDecision (Goto 200)))))))))
    ),
    ( 3,
      Chapter
        "3"
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 1})] (Goto 62)))
    ),
    ( 4,
      Chapter
        "4"
    ...
    ( 6,
      Chapter
        ...
        (Decisions [("If you wish to investigate the wagon, turn to 80.", NoDecision (Goto 80)), ("If you decide to ignore the wagon and ride south along the highway, turn to 175.", NoDecision (Goto 175))])
    ),
    ( 7,
      Chapter
        "7"
    ...
    ( 8,
      Chapter
        ...
        (Decisions [("If you wish to enter the tunnel, turn to 151.", NoDecision (Goto 151)), ("If you decide not to enter the tunnel, you can return to the rowing boat and continue along the underground river by turning to 240.", NoDecision (Goto 240))])
    ),
    ( 9,
      Chapter
        "9"
        ...
        (Decisions [("If you wish to tighten your grip and brace yourself for the shock of impact, turn to 112.", NoDecision (Goto 112)), ("If you decide to leap clear of the swinging bridge into the unknown depth of the mine shaft, turn to 342.", NoDecision (Goto 342))])
    ),
    ( 10,
      Chapter
        "10"
        ...
        (CanTake (GenSpecial (GenCounter 11)) 1 (NoDecision (Goto 59)))
    ),
    ( 11,
      Chapter
        "11"
    ...
    ( 13,
      Chapter
        ...
        (NoDecision (Randomly [(1 % 2, Goto 171), (1 % 2, Goto 25)]))
    ),
    ( 14,
      Chapter
        "14"
        ...
        (EvadeFight 0 31 (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 17}, _fendurance = Endurance {getEndurance = 28}, _fightMod = []}) (Goto 146))
    ),
    ( 15,
      Chapter
        "15"
        "You have ridden less than a hundred yards when you notice fresh hoof prints in the dust of the winding track.\n"
        (Decisions [("If you have the Kai Discipline of Tracking, turn to 264.", Conditional (HasDiscipline Tracking) (NoDecision (Goto 264))), ("otherwise", Conditional (Not (HasDiscipline Tracking)) (Decisions [("If you do not possess this skill, turn to 134.", NoDecision (Goto 134))]))])
    ),
    ( 16,
      Chapter
        "16"
        ...
        (Decisions [("If you wish to run straight into the forest, turn to 123.", NoDecision (Goto 123)), ("If you wish to try to change direction as soon as the trees hide you from your pursuers, turn to 169.", NoDecision (Goto 169))])
    ),
    ( 17,
      Chapter
        "17"
    ...
    ( 19,
      Chapter
        ...
        (NoDecision (Simple [MustEat NoHunt] (Goto 233)))
    ),
    ( 20,
      Chapter
        "20"
    ...
    ( 21,
      Chapter
        ...
        (Decisions [("If you have the Kai Discipline of Tracking, turn to 264.", Conditional (HasDiscipline Tracking) (NoDecision (Goto 264))), ("otherwise", Conditional (Not (HasDiscipline Tracking)) (Decisions [("If you wish to follow it east, turn to 134.", NoDecision (Goto 134)), ("If you wish to it west, turn to 191.", NoDecision (Goto 191))]))])
    ),
    ( 22,
      Chapter
        "22"
        "You fumble for your light, and in doing so, you drop one other item from your Backpack into the crevasse. (If you were not carrying any Backpack Items other than a Torch that you are now using, you have lost a Weapon instead.)\nYou eventually manage to make your way safely across to the other side of the bridge.\n"
        (NoDecision (LoseItemFrom BackpackSlot 1 (Goto 157)))
    ),
    ( 23,
      Chapter
        "23"
        "You reach the door, but only to find it locked.\n"
        (Decisions [("If you possess a Brass Key, turn to 282.", Conditional (HasItem (GenSpecial (GenCounter 0)) 1) (NoDecision (Goto 282))), ("otherwise", Conditional (Not (HasItem (GenSpecial (GenCounter 0)) 1)) (Decisions [("If you do not, turn to 105.", NoDecision (Goto 105))]))])
    ),
    ( 24,
      Chapter
        "24"
        ...
        (Decisions [("If you have the Kai Discipline of Healing, you can help this wounded soldier by turning to 238.", Conditional (HasDiscipline Healing) (NoDecision (Goto 238))), ("If you wish to continue up the stairs to the watchtower roof, turn to 223.", NoDecision (Goto 223)), ("If you wish to pick up the wounded archer's bow and man his position at the arrow slit, turn to 207.", NoDecision (Goto 207))])
    ),
    ( 25,
      Chapter
        "25"
        ...
        (Decisions [("If you wish to set up camp for the night in the shelter of the ruins, turn to 290.", NoDecision (Goto 290)), ("If you wish to avoid the temple and continue, turn to 141.", NoDecision (Goto 141))])
    ),
    ( 26,
      Chapter
        "26"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Stoneworm", _fcombatSkill = CombatSkill {getCombatSkill = 15}, _fendurance = Endurance {getEndurance = 38}, _fightMod = [MindblastImmune]}) (Goto 321)))
    ),
    ( 27,
      Chapter
        "27"
    ...
    ( 29,
      Chapter
        "29"
        "The Torch burns fiercely for just a few seconds before it sputters and dies. You try to relight it but it is hopeless-it simply will not burn. If you possess other Torches in your Backpack, you will also discover that for some mysterious reason, they will no longer light. (You need not erase any Torches from your Action Chart in this instance.)\n"
        (Decisions [("If you possess a Firesphere, turn to 168.", Conditional (HasItem (GenSpecial (GenCounter 1)) 1) (NoDecision (Goto 168))), ("otherwise", Conditional (Not (HasItem (GenSpecial (GenCounter 1)) 1)) (Decisions [("If you wish to continue in the dark, turn to 246.", NoDecision (Goto 246)), ("If you wish to leave the vault and attempt an entry via the guarded crypt door, turn to 183.", NoDecision (Goto 183))]))])
    ),
    ( 30,
      Chapter
        "30"
    ...
    ( 31,
      Chapter
        ...
        (NoDecision (Randomly [(1 % 2, Goto 272), (1 % 2, Goto 329)]))
    ),
    ( 32,
      Chapter
        "32"
    ...
    ( 33,
      Chapter
        ...
        (Decisions [("If you wish to set up camp at the edge of the forest, turn to 74.", NoDecision (Goto 74)), ("If you wish to send some men into the valley to scout for bandits, turn to 139.", NoDecision (Goto 139)), ("If you decide to go without food and sleep and press on to Ruanon as quickly as possible, turn to 251.", NoDecision (Goto 251))])
    ),
    ( 34,
      Chapter
        "34"
        ...
        (Decisions [("If you wish to continue along the corridor, turn to 235.", NoDecision (Goto 235)), ("If you wish to leave the vault and attempt to enter the temple via the guarded crypt door, turn to 183.", NoDecision (Goto 183))])
    ),
    ( 35,
      Chapter
        "35"
        ...
        (NoDecision (Conditionally [(COr (HasDiscipline Hunting) (HasLevel Guardian), Randomly [(1 % 2, Goto 147), (1 % 2, Goto 231)]), (Always True, Randomly [(4 % 5, Goto 147), (1 % 5, Goto 231)])]))
    ),
    ( 36,
      Chapter
        "36"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Vassagonian Warhound", _fcombatSkill = CombatSkill {getCombatSkill = 17}, _fendurance = Endurance {getEndurance = 25}, _fightMod = [Timed 3 (OnNotYetWon 277)]}) (Goto 155)))
    ),
    ( 37,
      Chapter
        "37"
        ...
        (Decisions [("If you wish to set up camp with the troubadours, turn to 182.", NoDecision (Goto 182)), ("If you decide to press on to Ruanon, turn to 247.", NoDecision (Goto 247))])
    ),
    ( 38,
      Chapter
        "38"
        ...
        (Decisions [("If you wish to continue along the highway, riding full speed for Ruanon, turn to 297.", NoDecision (Goto 297)), ("If you wish to avoid the main highway and continue by the eastern track, turn to 15.", NoDecision (Goto 15))])
    ),
    ( 39,
      Chapter
        "39"
    ...
    ( 40,
      Chapter
        ...
        (Decisions [("If you have the Kai Discipline of Tracking, and if you have reached the Kai rank of Aspirant or higher, turn to 349.", Conditional (CAnd (HasDiscipline Tracking) (HasLevel Aspirant)) (NoDecision (Goto 349))), ("otherwise", Conditional (Not (HasDiscipline Tracking)) (Decisions [("If you wish to follow the wagon track into the west tunnel, turn to 55.", NoDecision (Goto 55)), ("If you wish to climb the stairs to the balcony and explore the passage, turn to 291.", NoDecision (Goto 291))]))])
    ),
    ( 41,
      Chapter
        "41"
    ...
    ( 43,
      Chapter
        ...
        (NoDecision (Conditionally [(CAnd (COr (HasDiscipline MindOverMatter) (COr (COr (COr (COr (COr (COr (COr (COr (COr (COr (HasDiscipline (WeaponSkill Dagger)) (HasDiscipline (WeaponSkill Spear))) (HasDiscipline (WeaponSkill Mace))) (HasDiscipline (WeaponSkill ShortSword))) (HasDiscipline (WeaponSkill Warhammer))) (HasDiscipline (WeaponSkill Sword))) (HasDiscipline (WeaponSkill Axe))) (HasDiscipline (WeaponSkill Quarterstaff))) (HasDiscipline (WeaponSkill BroadSword))) (HasDiscipline (WeaponSkill MagicSpear))) (HasDiscipline (WeaponSkill Sommerswerd)))) (COr (HasDiscipline Hunting) (HasDiscipline SixthSense)), Randomly [(2 % 5, Goto 262), (3 % 5, Goto 111)]), (COr (HasDiscipline MindOverMatter) (COr (COr (COr (COr (COr (COr (COr (COr (COr (COr (HasDiscipline (WeaponSkill Dagger)) (HasDiscipline (WeaponSkill Spear))) (HasDiscipline (WeaponSkill Mace))) (HasDiscipline (WeaponSkill ShortSword))) (HasDiscipline (WeaponSkill Warhammer))) (HasDiscipline (WeaponSkill Sword))) (HasDiscipline (WeaponSkill Axe))) (HasDiscipline (WeaponSkill Quarterstaff))) (HasDiscipline (WeaponSkill BroadSword))) (HasDiscipline (WeaponSkill MagicSpear))) (HasDiscipline (WeaponSkill Sommerswerd))), Randomly [(3 % 5, Goto 262), (2 % 5, Goto 111)]), (COr (HasDiscipline Hunting) (HasDiscipline SixthSense), Randomly [(1 % 2, Goto 262), (1 % 2, Goto 111)]), (Always True, Randomly [(7 % 10, Goto 262), (3 % 10, Goto 111)])]))
    ),
    ( 44,
      Chapter
        "44"
        ...
        (CanTake Gold 12 (CanTake Meal 2 (Decisions [("If you have the Kai Discipline of Healing, turn to 149.", Conditional (HasDiscipline Healing) (NoDecision (Goto 149))), ("otherwise", Conditional (Not (HasDiscipline Healing)) (Decisions [("If you do not possess this skill, turn to 188.", NoDecision (Goto 188))]))])))
    ),
    ( 45,
      Chapter
        "45"
    ...
    ( 46,
      Chapter
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Tunnel Fiend", _fcombatSkill = CombatSkill {getCombatSkill = 20}, _fendurance = Endurance {getEndurance = 10}, _fightMod = []}) (Goto 281)))
    ),
    ( 47,
      Chapter
        "47"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Giant Meresquid", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 37}, _fightMod = [Timed 5 (OnNotYetWon 340)]}) (Goto 32)))
    ),
    ( 48,
      Chapter
        "48"
    ...
    ( 50,
      Chapter
        ...
        (NoDecision (Randomly [(7 % 10, Goto 184), (3 % 10, Goto 267)]))
    ),
    ( 51,
      Chapter
        "51"
        ...
        (Decisions [("If you have the Kai Discipline of Animal Kinship, turn to 227.", Conditional (HasDiscipline AnimalKinship) (NoDecision (Goto 227))), ("otherwise", Conditional (Not (HasDiscipline AnimalKinship)) (Decisions [("If you wish to investigate the ridge, turn to 328.", NoDecision (Goto 328)), ("If you would rather ignore the birds and press on, turn to 120.", NoDecision (Goto 120))]))])
    ),
    ( 52,
      Chapter
        "52"
    ...
    ( 53,
      Chapter
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Wounded Bandit", _fcombatSkill = CombatSkill {getCombatSkill = 13}, _fendurance = Endurance {getEndurance = 16}, _fightMod = []}) (Goto 109)))
    ),
    ( 54,
      Chapter
        "54"
    ...
    ( 55,
      Chapter
        ...
        (Decisions [("If you wish to dive into one of the empty ore wagons, turn to 161.", NoDecision (Goto 161)), ("If you wish to hide in the shadows of the rough tunnel wall, turn to 286.", NoDecision (Goto 286))])
    ),
    ( 56,
      Chapter
        "56"
        "You hit the guard and open a deep wound in his neck. He screams and turns to face you, a short sword in his hand.\n"
        (NoDecision (Fight (FightDetails {_opponent = "Wounded Guard", _fcombatSkill = CombatSkill {getCombatSkill = 12}, _fendurance = Endurance {getEndurance = 18}, _fightMod = [Timed 3 (OnNotYetWon 203)]}) (Goto 69)))
    ),
    ( 57,
      Chapter
        "57"
        ...
        (NoDecision (Conditionally [(CAnd (HasItem (Weapon Sword) 1) (HasFlag Special01), Goto 327), (Always True, Goto 289)]))
    ),
    ( 58,
      Chapter
        "58"
        ...
        (Decisions [("If you wish to enter the large caravan, turn to 222.", NoDecision (Goto 222)), ("If you decide to investigate the smaller coach, turn to 110.", NoDecision (Goto 110))])
    ),
    ( 59,
      Chapter
        "59"
        ...
        (NoDecision (Randomly [(1 % 2, Goto 193), (1 % 2, Goto 260)]))
    ),
    ( 60,
      Chapter
        "60"
    ...
    ( 61,
      Chapter
        ...
        (Decisions [("If you wish to hack at the tentacle that is coiled around the ranger's foot, turn to 304.", NoDecision (Goto 304)), ("If you wish to aid the unconscious ranger lying at your feet, turn to 136.", NoDecision (Goto 136)), ("If you wish to grab the oars and row for the bank, turn to 189.", NoDecision (Goto 189))])
    ),
    ( 62,
      Chapter
        "62"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 17}, _fendurance = Endurance {getEndurance = 24}, _fightMod = [Timed 3 (CombatBonus (CombatSkill {getCombatSkill = -2}))]}) (Goto 148)))
    ),
    ( 63,
      Chapter
        "63"
        ...
        (NoDecision (Randomly [(1 % 2, Goto 259), (1 % 2, Goto 95)]))
    ),
    ( 64,
      Chapter
        "64"
        ...
        (Decisions [("If you wish to ascend the stairs, turn to 170.", NoDecision (Goto 170)), ("If you wish to descend the stairs, turn to 228.", NoDecision (Goto 228))])
    ),
    ( 65,
      Chapter
        "65"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Tunnel Fiends", _fcombatSkill = CombatSkill {getCombatSkill = 20}, _fendurance = Endurance {getEndurance = 10}, _fightMod = []}) (Goto 298)))
    ),
    ( 66,
      Chapter
        "66"
    ...
    ( 67,
      Chapter
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 1})] (Conditionally [(HasItem (Weapon Sommerswerd) 1, Goto 292), (COr (HasDiscipline Hunting) (HasDiscipline MindOverMatter), Randomly [(3 % 10, Goto 242), (2 % 5, Goto 263), (3 % 10, Goto 278)]), (Always True, Randomly [(1 % 2, Goto 242), (2 % 5, Goto 263), (1 % 10, Goto 278)])])))
    ),
    ( 68,
      Chapter
        "68"
        ...
        (Decisions [("If you wish to launch the rowing boat, turn to 180.", NoDecision (Goto 180)), ("If you wish to search the boathouse for other useful items, turn to 213.", NoDecision (Goto 213))])
    ),
    ( 69,
      Chapter
        "69"
        ...
        (Decisions [("If you wish to pull the rope, turn to 125.", NoDecision (Goto 125)), ("If you wish to ignore the rope and escape into the tunnel, turn to 348.", NoDecision (Goto 348))])
    ),
    ( 70,
      Chapter
        "70"
        ...
        (NoDecision (Conditionally [(HasItem (GenSpecial (GenCounter 11)) 1, Goto 305), (CAnd (HasDiscipline Camouflage) (HasLevel Guardian), Goto 49), (Always True, Goto 159)]))
    ),
    ( 71,
      Chapter
        "71"
    ...
    ( 73,
      Chapter
        ...
        (Decisions [("If you possess a Flask of Holy Water, turn to 283.", Conditional (HasItem (GenBackpack (GenCounter 0)) 1) (NoDecision (Goto 283))), ("otherwise", Conditional (Not (HasItem (GenBackpack (GenCounter 0)) 1)) (Decisions [("If you do not possess this item, turn to 325.", NoDecision (Goto 325))]))])
    ),
    ( 74,
      Chapter
        "74"
        ...
        (Decisions [("If you wish to search the wrecked wagon, turn to 38.", NoDecision (Simple [HealPlayer (Endurance {getEndurance = 1})] (Goto 38))), ("If you wish to ignore the wagon and continue along the highway, turn to 175.", NoDecision (Simple [HealPlayer (Endurance {getEndurance = 1})] (Goto 175))), ("If you wish to investigate the track leading into the hills, turn to 293.", NoDecision (Simple [HealPlayer (Endurance {getEndurance = 1})] (Goto 293)))])
    ),
    ( 75,
      Chapter
        "75"
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 2})] (Conditionally [(HasDiscipline Camouflage, Randomly [(3 % 10, Goto 192), (7 % 10, Goto 16)]), (Always True, Randomly [(3 % 5, Goto 192), (2 % 5, Goto 16)])])))
    ),
    ( 76,
      Chapter
        "76"
        ...
        (Decisions [("If you wish to search them, turn to 268.", NoDecision (Goto 268)), ("If you wish to leave the chamber, turn to 64.", NoDecision (Goto 64))])
    ),
    ( 77,
      Chapter
        "77"
        ...
        (EvadeFight 2 98 (FightDetails {_opponent = "Vassaginian Captain", _fcombatSkill = CombatSkill {getCombatSkill = 22}, _fendurance = Endurance {getEndurance = 28}, _fightMod = [MindblastImmune, EnemyMindblast]}) (Goto 10))
    ),
    ( 78,
      Chapter
        "78"
        ...
        (CanTake (GenBackpack (GenCounter 0)) 1 (NoDecision (Simple [MustEat Hunt] (Goto 233))))
    ),
    ( 79,
      Chapter
        "79"
        ...
        (CanTake (GenBackpack (GenCounter 2)) 1 (CanTake (GenBackpack (GenCounter 1)) 5 (NoDecision (Goto 117))))
    ),
    ( 80,
      Chapter
        "80"
    ...
    ( 81,
      Chapter
        ...
        (Decisions [("If you wish to knock away the roof prop, turn to 173.", NoDecision (Goto 173)), ("If you decide to ignore the prop and press on along the tunnel, turn to 224.", NoDecision (Goto 224))])
    ),
    ( 82,
      Chapter
        "82"
        ...
        (Decisions [("If you wish to investigate the wagon, turn to 337.", NoDecision (Goto 337)), ("If you decide to ignore the wagon and continue, turn to 297.", NoDecision (Goto 297)), ("If you wish to explore the hill track, turn to 15.", NoDecision (Goto 15))])
    ),
    ( 83,
      Chapter
        "83"
    ...
    ( 84,
      Chapter
        ...
        (CanTake (GenSpecial (GenCounter 2)) 1 (NoDecision (Goto 273)))
    ),
    ( 85,
      Chapter
        "85"
    ...
    ( 87,
      Chapter
        ...
        (Decisions [("If you have the Kai Discipline of Sixth Sense or Tracking, turn to 60.", Conditional (COr (HasDiscipline SixthSense) (HasDiscipline Tracking)) (NoDecision (Goto 60))), ("otherwise", Conditional (Not (COr (HasDiscipline SixthSense) (HasDiscipline Tracking))) (Decisions [("If you wish to enter the left tunnel, turn to 199.", NoDecision (Goto 199)), ("If you wish to enter the right tunnel, turn to 208.", NoDecision (Goto 208))]))])
    ),
    ( 88,
      Chapter
        "88"
    ...
    ( 89,
      Chapter
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 17}, _fendurance = Endurance {getEndurance = 26}, _fightMod = []}) (Goto 7)))
    ),
    ( 90,
      Chapter
        "90"
        "You are in combat with a Vassagonian horseman who is now on foot. You cannot evade him and must fight him to the death.\n"
        (NoDecision (Fight (FightDetails {_opponent = "Bandit Horseman", _fcombatSkill = CombatSkill {getCombatSkill = 17}, _fendurance = Endurance {getEndurance = 24}, _fightMod = []}) (Goto 249)))
    ),
    ( 91,
      Chapter
        "91"
        ...
        (Decisions [("If you wish to climb the mound and squeeze through the gap, turn to 254.", NoDecision (Goto 254)), ("If you decide to call off the search, you can return to the surface, remount your horses, and descend the hill track by turning to 191.", NoDecision (Goto 191))])
    ),
    ( 92,
      Chapter
        "92"
        ...
        (Decisions [("If you have the Kai Discipline of Sixth Sense, turn to 210.", Conditional (HasDiscipline SixthSense) (NoDecision (Goto 210))), ("otherwise", Conditional (Not (HasDiscipline SixthSense)) (Decisions [("If you wish to enter the tavern, turn to 132.", NoDecision (Goto 132)), ("If you decide to continue along the street, turn to 301.", NoDecision (Goto 301))]))])
    ),
    ( 93,
      Chapter
        "93"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 15}, _fendurance = Endurance {getEndurance = 26}, _fightMod = []}) (Goto 2)))
    ),
    ( 94,
      Chapter
        "94"
        ...
        (NoDecision (Simple [LoseItemKind [BackpackSlot]] (Goto 219)))
    ),
    ( 95,
      Chapter
        "95"
        ...
        (Decisions [("If you wish to say that you are a Kai Lord and that your men are Border Rangers of Sommerlund, turn to 259.", NoDecision (Goto 259)), ("If you wish to show them your Badge of Rank, turn to 195.", NoDecision (Goto 195))])
    ),
    ( 96,
      Chapter
        "96"
        ...
        (NoDecision (Randomly [(1 % 2, Goto 47), (2 % 5, Goto 234), (1 % 10, Goto 334)]))
    ),
    ( 97,
      Chapter
        "97"
    ...
    ( 101,
      Chapter
        ...
        (Decisions [("If you wish to row across to the other bank and take the west tunnel, turn to 343.", NoDecision (Goto 343)), ("If you wish to take the boat and continue south via the river, turn to 115.", NoDecision (Goto 115))])
    ),
    ( 102,
      Chapter
        "102"
        ...
        (CanTake Gold 12 (CanTake Meal 2 (Decisions [("If you possess the Kai Discipline of Healing, turn to 19.", Conditional (HasDiscipline Healing) (NoDecision (Goto 19))), ("otherwise", Conditional (Not (HasDiscipline Healing)) (Decisions [("If you do not have this skill, turn to 339.", NoDecision (Goto 339))]))])))
    ),
    ( 103,
      Chapter
        "103"
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 4})] (Goto 59)))
    ),
    ( 104,
      Chapter
        "104"
        ...
        (Decisions [("If you want to try to dive for the far side, turn to 303.", NoDecision (Goto 303)), ("If you wish to jump clear of the bridge and dive into the unknown depths of the mine shaft, turn to 342.", NoDecision (Goto 342))])
    ),
    ( 105,
      Chapter
        "105"
        ...
        (Decisions [("If you wish to attack the guards, turn to 285.", NoDecision (Goto 285)), ("If you wish to raise your hands and surrender, turn to 267.", NoDecision (Goto 267))])
    ),
    ( 106,
      Chapter
        "106"
        ...
        (Decisions [("If you wish to leave Eshnar as quickly as possible, turn to 67.", NoDecision (Goto 67)), ("If you decide to investigate the stables, turn to 236.", NoDecision (Goto 236))])
    ),
    ( 107,
      Chapter
        "107"
        ...
        (Decisions [("If you wish to follow him, turn to 59.", NoDecision (Goto 59)), ("If you wish to continue towards the watchtower, turn to 310.", NoDecision (Goto 310))])
    ),
    ( 108,
      Chapter
        "108"
        ...
        (EvadeFight 0 271 (FightDetails {_opponent = "Tunnel Guard Officer", _fcombatSkill = CombatSkill {getCombatSkill = 20}, _fendurance = Endurance {getEndurance = 30}, _fightMod = []}) (Goto 28))
    ),
    ( 109,
      Chapter
        "109"
        ...
        (CanTake Gold 3 (CanTake (Weapon Dagger) 1 (CanTake (Weapon Sword) 1 (Decisions [("If you wish to search the cellar, turn to 347.", NoDecision (Goto 347)), ("If you wish to leave the hut, turn to 258.", NoDecision (Goto 258))]))))
    ),
    ( 110,
      Chapter
        "110"
    ...
    ( 111,
      Chapter
        ...
        (Decisions [("If you wish to fight him, turn to 90.", NoDecision (Goto 90)), ("If you wish to evade combat, turn to 163.", NoDecision (Goto 163))])
    ),
    ( 112,
      Chapter
        "112"
        ...
        (NoDecision (Conditionally [(HasEndurance (Endurance {getEndurance = 21}), Randomly [(1 % 5, Goto 42), (4 % 5, Goto 303)]), (HasEndurance (Endurance {getEndurance = 10}), Randomly [(1 % 2, Goto 42), (1 % 2, Goto 303)]), (Always True, Randomly [(4 % 5, Goto 42), (1 % 5, Goto 303)])]))
    ),
    ( 113,
      Chapter
        "113"
        ...
        (Decisions [("If you have reached the Kai rank of Warmarn, turn to 166.", Conditional (HasLevel Warmarn) (NoDecision (Goto 166))), ("Otherwise.", Conditional (Not (HasLevel Warmarn)) (Decisions [("If you have yet to reach this level of Kai training, you can launch a surprise attack on the bandits and turn to 14.", NoDecision (Goto 14)), ("If you would rather try to sneak across the river under the cover of the many large boulders that divert the watercourse, turn to 316.", NoDecision (Goto 316)), ("If you would rather avoid crossing here and head back the way you have just come, turn to 232.", NoDecision (Goto 232))]))])
    ),
    ( 114,
      Chapter
        "114"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 25}, _fightMod = []}) (Goto 295)))
    ),
    ( 115,
      Chapter
        "115"
        ...
        (Decisions [("If you wish to land at the steps and investigate the tunnel, turn to 8.", NoDecision (Goto 8)), ("If you wish to continue south by the river, turn to 240.", NoDecision (Goto 240))])
    ),
    ( 116,
      Chapter
        "116"
    ...
    ( 117,
      Chapter
        ...
        (NoDecision (Conditionally [(COr (CAnd (HasItem (GenBackpack (GenCounter 2)) 1) (HasItem (GenBackpack (GenCounter 1)) 1)) (HasItem (GenSpecial (GenCounter 1)) 1), Goto 22), (COr (HasDiscipline SixthSense) (HasDiscipline Tracking), Randomly [(2 % 5, Goto 99), (3 % 5, Goto 256)]), (Always True, Randomly [(7 % 10, Goto 99), (3 % 10, Goto 256)])]))
    ),
    ( 118,
      Chapter
        "118"
        ...
        (Decisions [("If you possess an Iron Key, you may open the door by turning to 308.", Conditional (HasItem (GenSpecial (GenCounter 2)) 1) (NoDecision (Goto 308))), ("otherwise", Conditional (Not (HasItem (GenSpecial (GenCounter 2)) 1)) (Decisions [("If you wish to ascend the stairs, turn to 170.", NoDecision (Goto 170)), ("If you wish to descend the stairs, turn to 228.", NoDecision (Goto 228))]))])
    ),
    ( 119,
      Chapter
        "119"
        ...
        (Decisions [("If you wish to enter into combat with this warrior lord, turn to 296.", NoDecision (Goto 296)), ("If you wish to try to free Madelon, turn to 73.", NoDecision (Goto 73))])
    ),
    ( 120,
      Chapter
        "120"
        ...
        (Decisions [("If you wish to continue south, turn to 33.", NoDecision (Goto 33)), ("If you decide to go east, turn to 92.", NoDecision (Goto 92))])
    ),
    ( 121,
      Chapter
        "121"
    ...
    ( 124,
      Chapter
        ...
        (Decisions [("If you wish to stand and fight the horseman, turn to 333.", NoDecision (Goto 333)), ("If you wish to run back to the watchtower, turn to 107.", NoDecision (Goto 107))])
    ),
    ( 125,
      Chapter
        "125"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Tunnel Guard Leader", _fcombatSkill = CombatSkill {getCombatSkill = 20}, _fendurance = Endurance {getEndurance = 30}, _fightMod = []}) (Fight (FightDetails {_opponent = "Tunnel Guard 1", _fcombatSkill = CombatSkill {getCombatSkill = 18}, _fendurance = Endurance {getEndurance = 26}, _fightMod = []}) (Fight (FightDetails {_opponent = "Tunnel Guard 2", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 24}, _fightMod = []}) (Goto 261)))))
    ),
    ( 126,
      Chapter
        "126"
        ...
        (NoDecision (Simple [MustEat Hunt] (Randomly [(1 % 2, Goto 25), (1 % 2, Goto 171)])))
    ),
    ( 127,
      Chapter
        "127"
        ...
        (Decisions [("If you wish to help the ranger who is pinned to the floor, turn to 178.", NoDecision (Simple [SetFlag FoughtElix] (Goto 178))), ("If you wish to help the ranger who is fighting at the bottom of the stairs, turn to 245.", NoDecision (Simple [SetFlag FoughtElix] (Goto 245)))])
    ),
    ( 128,
      Chapter
        "128"
        ...
        (NoDecision (Conditionally [(HasDiscipline Hunting, Randomly [(1 % 5, Goto 103), (4 % 5, Goto 98)]), (Always True, Randomly [(1 % 2, Goto 103), (1 % 2, Goto 98)])]))
    ),
    ( 129,
      Chapter
        "129"
        ...
        (NoDecision (Simple [MustEat NoHunt] (Goto 309)))
    ),
    ( 130,
      Chapter
        "130"
        ...
        (Decisions [("If you wish to return to the boathouse, turn to 68.", NoDecision (Goto 68)), ("If you wish to continue following the river towards the east, turn to 331.", NoDecision (Goto 331))])
    ),
    ( 131,
      Chapter
        "131"
    ...
    ( 132,
      Chapter
        ...
        (Decisions [("If you feel uneasy about the tavern and wish to leave town, turn to 67.", NoDecision (Goto 67)), ("If you wish to question the old woman, turn to 287.", NoDecision (Goto 287))])
    ),
    ( 133,
      Chapter
        "133"
        ...
        (EvadeFight 0 307 (FightDetails {_opponent = "Bandit Patrol", _fcombatSkill = CombatSkill {getCombatSkill = 18}, _fendurance = Endurance {getEndurance = 35}, _fightMod = [OnDamage 17]}) (Goto 265))
    ),
    ( 134,
      Chapter
        "134"
        ...
        (Decisions [("If you wish to enter the mine, turn to 91.", NoDecision (Goto 91)), ("If you decide to call off your search, return along the hill track and turn to 191.", NoDecision (Goto 191))])
    ),
    ( 135,
      Chapter
        "135"
        ...
        (Decisions [("If you wish to counterattack the bandits in the hope that your bold action will scare them off, turn to 284.", NoDecision (Goto 284)), ("If you wish to split your company, detaching a group of ten rangers to follow you whilst sending the remainder off towards the west in the hope of luring the bulk of the bandit horde away to the Durncrag Mountains, turn to 211.", NoDecision (Goto 211)), ("If you wish to head south at the gallop, to try to reach the shelter of the Ruanon Forest before the bandits close in, turn to 30.", NoDecision (Goto 30))])
    ),
    ( 136,
      Chapter
        "136"
        ...
        (Decisions [("If you have the Kai Discipline of Healing, turn to 313.", Conditional (HasDiscipline Healing) (NoDecision (Goto 313))), ("otherwise", Conditional (Not (HasDiscipline Healing)) (Decisions [("If you do not possess this skill, turn to 216.", NoDecision (Goto 216))]))])
    ),
    ( 137,
      Chapter
        "137"
    ...
    ( 138,
      Chapter
        ...
        (EvadeFight 0 81 (FightDetails {_opponent = "Drunken Guard", _fcombatSkill = CombatSkill {getCombatSkill = 13}, _fendurance = Endurance {getEndurance = 29}, _fightMod = []}) (Goto 152))
    ),
    ( 139,
      Chapter
        "139"
        ...
        (Decisions [("If you wish to send three more scouts into the wooded valley, turn to 206.", NoDecision (Simple [MustEat Hunt] (Goto 206))), ("If you wish to wait until dawn before you investigate their disappearance, turn to 330.", NoDecision (Simple [MustEat Hunt] (Goto 330))), ("If you decide that it is far too dangerous to stay here, you can still ride east towards the town of Eshnar by turning to 92.", NoDecision (Simple [MustEat Hunt] (Goto 92)))])
    ),
    ( 140,
      Chapter
        "140"
        ...
        (Decisions [("If you wish to venture through the trees to the right of the highway, turn to 70.", NoDecision (Goto 70)), ("If you wish to pass through the trees to the left, turn to 314.", NoDecision (Goto 314))])
    ),
    ( 141,
      Chapter
        "141"
        ...
        (NoDecision (Simple [MustEat Hunt] (Goto 253)))
    ),
    ( 142,
      Chapter
        "142"
        ...
        (Decisions [("If you wish to try to enter the temple through the guarded crypt door, turn to 183.", NoDecision (Goto 183)), ("If you wish to try to enter the temple via the unguarded marble stairs, turn to 270.", NoDecision (Goto 270))])
    ),
    ( 143,
      Chapter
        "143"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Tunnel Guard 1", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 22}, _fightMod = []}) (Goto 360)))
    ),
    ( 144,
      Chapter
        "144"
    ...
    ( 145,
      Chapter
        ...
        (Decisions [("If you wish to rest in the hut, turn to 322.", NoDecision (Goto 322)), ("If you wish to press on regardless of fatigue, turn to 162.", NoDecision (Goto 162))])
    ),
    ( 146,
      Chapter
        "146"
    ...
    ( 147,
      Chapter
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Bridge Guard", _fcombatSkill = CombatSkill {getCombatSkill = 14}, _fendurance = Endurance {getEndurance = 23}, _fightMod = [Timed 1 PlayerInvulnerable]}) (Goto 280)))
    ),
    ( 148,
      Chapter
        "148"
    ...
    ( 150,
      Chapter
        ...
        (Decisions [("If you wish to send your men in search of the missing horses, turn to 164.", NoDecision (Goto 164)), ("If you wish to follow the footprints into the mine, turn to 288.", NoDecision (Goto 288)), ("If you wish to call off the search, you can return along the hill track by turning to 6.", NoDecision (Goto 6))])
    ),
    ( 151,
      Chapter
        "151"
        ...
        (Decisions [("If you wish to signal to your men to attack the guards, turn to 320.", NoDecision (Goto 320)), ("If you wish to try to lure them into the tunnel and capture them alive, turn to 197.", NoDecision (Goto 197))])
    ),
    ( 152,
      Chapter
        "152"
        ...
        (CanTake Gold 6 (CanTake (Weapon Sword) 1 (CanTake Meal 2 (CanTake (GenSpecial (GenCounter 0)) 1 (NoDecision (Goto 81))))))
    ),
    ( 153,
      Chapter
        "153"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Vassagonian Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 17}, _fendurance = Endurance {getEndurance = 26}, _fightMod = [Timed 2 (CombatBonus (CombatSkill {getCombatSkill = -4}))]}) (Goto 174)))
    ),
    ( 154,
      Chapter
        "154"
        ...
        (NoDecision (Randomly [(3 % 10, Goto 120), (7 % 10, Goto 51)]))
    ),
    ( 155,
      Chapter
        "155"
    ...
    ( 156,
      Chapter
        ...
        (Decisions [("If you wish to climb the ladder to the level above turn to 212.", NoDecision (Goto 212)), ("If you decide to retrace your steps back to the previous chamber and take the south tunnel, turn to 101.", NoDecision (Goto 101))])
    ),
    ( 157,
      Chapter
        "157"
        ...
        (NoDecision (Simple [HealPlayer (Endurance {getEndurance = 1})] (Goto 309)))
    ),
    ( 158,
      Chapter
        "158"
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 3}), LoseItemKind [BackpackSlot]] (Goto 219)))
    ),
    ( 159,
      Chapter
        "159"
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 2})] (Goto 204)))
    ),
    ( 160,
      Chapter
        "160"
        ...
        (Decisions [("If you wish to open the door and enter, turn to 84.", NoDecision (Goto 84)), ("If you wish to draw your weapon and kick open the door, turn to 205.", NoDecision (Goto 205)), ("If you wish to send your rangers into the hut, turn to 306.", NoDecision (Goto 306))])
    ),
    ( 161,
      Chapter
        "161"
        ...
        (Decisions [("If you wish to leap from the wagon and run to the left, turn to 27.", NoDecision (Goto 27)), ("If you wish to jump from the wagon and run to the right, turn to 144.", NoDecision (Goto 144)), ("If you decide to ignore the command and stay where you are, turn to 294.", NoDecision (Goto 294))])
    ),
    ( 162,
      Chapter
        "162"
        "Two mine tunnels lead out of the chamber. One heads towards the west, the other towards the south.\n"
        (Decisions [("If you wish to go west, turn to 214.", NoDecision (Goto 214)), ("If you wish to go south, turn to 117.", NoDecision (Goto 117))])
    ),
    ( 163,
      Chapter
        "163"
    ...
    ( 164,
      Chapter
        ...
        (Decisions [("If you wish to rally your men to stand and fight, turn to 299.", NoDecision (Goto 299)), ("If you decide to order a hasty retreat into the mine, turn to 52.", NoDecision (Goto 52))])
    ),
    ( 165,
      Chapter
        "165"
        ...
        (Decisions [("accept the meal", NoDecision (Goto 319)), ("eat your own", NoDecision (Simple [MustEat NoHunt] (Goto 13)))])
    ),
    ( 166,
      Chapter
        "166"
    ...
    ( 167,
      Chapter
        ...
        (CanTake Backpack 1 (CanTake Meal 2 (NoDecision (Goto 185))))
    ),
    ( 168,
      Chapter
        "168"
        ...
        (Decisions [("If you possess the Sommerswerd, turn to 34.", Conditional (HasItem (Weapon Sommerswerd) 1) (NoDecision (Goto 34))), ("otherwise", Conditional (Not (HasItem (Weapon Sommerswerd) 1)) (Decisions [("If you do not possess this Special Item, turn to 85.", NoDecision (Goto 85))]))])
    ),
    ( 169,
      Chapter
        "169"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 24}, _fightMod = []}) (Goto 123)))
    ),
    ( 170,
      Chapter
        "170"
        ...
        (Decisions [("If you wish to descend the staircase, turn to 228.", NoDecision (Goto 228)), ("If you wish to continue along the passage, turn to 221.", NoDecision (Goto 221))])
    ),
    ( 171,
      Chapter
        "171"
        ...
        (Decisions [("If you wish to stop at the tavern for the night, turn to 63.", NoDecision (Goto 63)), ("If you decide to brave a possible storm and continue to ride south, turn to 141.", NoDecision (Goto 141))])
    ),
    ( 172,
      Chapter
        "172"
    ...
    ( 173,
      Chapter
        ...
        (NoDecision (Conditionally [(HasItem (Weapon Sommerswerd) 1, Goto 275), (CAnd (HasItem (GenBackpack (GenCounter 3)) 1) (HasItem (GenBackpack (GenCounter 4)) 1), Randomly [(1 % 2, Goto 143), (1 % 2, Goto 179)]), (Always True, Randomly [(7 % 10, Goto 143), (3 % 10, Goto 179)])]))
    ),
    ( 174,
      Chapter
        "174"
    ...
    ( 176,
      Chapter
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 3})] (Fight (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 17}, _fendurance = Endurance {getEndurance = 25}, _fightMod = []}) (Goto 7))))
    ),
    ( 177,
      Chapter
        "177"
    ...
    ( 182,
      Chapter
        ...
        (Decisions [("Chase", NoDecision (Conditionally [(COr (HasDiscipline Tracking) (HasDiscipline Hunting), Goto 332), (Always True, Goto 58)])), ("If you decide to let him go, return to your men by turning to 165.", NoDecision (Goto 165))])
    ),
    ( 183,
      Chapter
        "183"
        ...
        (NoDecision (Conditionally [(HasDiscipline Camouflage, Randomly [(3 % 10, Goto 198), (7 % 10, Goto 338)]), (Always True, Randomly [(7 % 10, Goto 198), (3 % 10, Goto 338)])]))
    ),
    ( 184,
      Chapter
        "184"
        ...
        (Decisions [("If you wish to fight them, turn to 202.", NoDecision (Goto 202)), ("If you wish to dive over the parapet of the bridge to avoid them, turn to 342.", NoDecision (Goto 342))])
    ),
    ( 185,
      Chapter
        "185"
        ...
        (NoDecision (Simple [MustEat NoHunt] (Goto 40)))
    ),
    ( 186,
      Chapter
        "186"
        ...
        (EvadeFight 0 66 (FightDetails {_opponent = "Vassagonian Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 18}, _fendurance = Endurance {getEndurance = 25}, _fightMod = []}) (Goto 243))
    ),
    ( 187,
      Chapter
        "187"
    ...
    ( 188,
      Chapter
        ...
        (NoDecision (Simple [MustEat Hunt] (Goto 233)))
    ),
    ( 189,
      Chapter
        "189"
        ...
        (NoDecision (Randomly [(1 % 2, Goto 234), (1 % 2, Goto 47)]))
    ),
    ( 190,
      Chapter
        "190"
    ...
    ( 191,
      Chapter
        ...
        (Decisions [("If you wish to examine the wagon, turn to 337.", NoDecision (Goto 337)), ("If you decide to ignore the wreck, you can continue your ride south along the highway, by turning to 297.", NoDecision (Goto 297))])
    ),
    ( 192,
      Chapter
        "192"
    ...
    ( 193,
      Chapter
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Vassagonian Warhounds", _fcombatSkill = CombatSkill {getCombatSkill = 17}, _fendurance = Endurance {getEndurance = 30}, _fightMod = [Timed 2 (StopFight 311)]}) (Goto 311)))
    ),
    ( 194,
      Chapter
        "194"
        ...
        (NoDecision (Randomly [(1 % 10, Fight (FightDetails {_opponent = "Giant Meresquid", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 37}, _fightMod = [Timed 1 ForceEMindblast]}) (Goto 32)), (1 % 10, Fight (FightDetails {_opponent = "Giant Meresquid", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 37}, _fightMod = [Timed 2 ForceEMindblast]}) (Goto 32)), (1 % 10, Fight (FightDetails {_opponent = "Giant Meresquid", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 37}, _fightMod = [Timed 3 ForceEMindblast]}) (Goto 32)), (1 % 10, Fight (FightDetails {_opponent = "Giant Meresquid", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 37}, _fightMod = [Timed 4 ForceEMindblast]}) (Goto 32)), (1 % 10, Fight (FightDetails {_opponent = "Giant Meresquid", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 37}, _fightMod = [Timed 5 ForceEMindblast]}) (Goto 32)), (1 % 10, Fight (FightDetails {_opponent = "Giant Meresquid", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 37}, _fightMod = [Timed 6 ForceEMindblast]}) (Goto 32)), (1 % 10, Fight (FightDetails {_opponent = "Giant Meresquid", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 37}, _fightMod = [Timed 7 ForceEMindblast]}) (Goto 32)), (1 % 10, Fight (FightDetails {_opponent = "Giant Meresquid", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 37}, _fightMod = [Timed 8 ForceEMindblast]}) (Goto 32)), (1 % 10, Fight (FightDetails {_opponent = "Giant Meresquid", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 37}, _fightMod = [Timed 9 ForceEMindblast]}) (Goto 32)), (1 % 10, Fight (FightDetails {_opponent = "Giant Meresquid", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 37}, _fightMod = [Timed 10 ForceEMindblast]}) (Goto 32))]))
    ),
    ( 195,
      Chapter
        "195"
        ...
        (Decisions [("If you wish to question the tavern-keeper about the nature of the bandit raids, turn to 239.", NoDecision (Goto 239)), ("If you wish to question him about any news that he may have heard about Ruanon in the last month, then turn to 266.", NoDecision (Goto 266)), ("If you do not wish to question the man further, you can prepare for a night's sleep and turn to 324.", NoDecision (Goto 324))])
    ),
    ( 196,
      Chapter
        "196"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 23}, _fightMod = []}) (Goto 217)))
    ),
    ( 197,
      Chapter
        "197"
        ...
        (Decisions [("If you wish to search them, turn to 268.", NoDecision (Goto 268)), ("If you wish to question them, turn to 76.", NoDecision (Goto 76)), ("If you wish to leave them and continue on your way, turn to 64.", NoDecision (Goto 64))])
    ),
    ( 198,
      Chapter
        "198"
        "The guards are not fooled by your bravado-they draw their weapons and attack. You must fight them as one enemy.\n"
        (NoDecision (Fight (FightDetails {_opponent = "Crypt Guards", _fcombatSkill = CombatSkill {getCombatSkill = 18}, _fendurance = Endurance {getEndurance = 30}, _fightMod = []}) (Goto 229)))
    ),
    ( 199,
      Chapter
        "199"
        ...
        (Decisions [("If you wish to sprint across the bridge, turn to 271.", NoDecision (Goto 271)), ("If you wish to attack the guard to prevent him from reaching the rope, turn to 56.", NoDecision (Goto 56))])
    ),
    ( 200,
      Chapter
        "200"
        ...
        (Decisions [("If you possess the Kai Discipline of Hunting or if you have ever visited Gorn Cove, turn to 45.", Conditional (COr (HasDiscipline Hunting) (HasFlag Special02)) (NoDecision (Goto 45))), ("otherwise", Conditional (Not (COr (HasDiscipline Hunting) (HasFlag Special02))) (Decisions [("If you wish to fight the bandits, turn to 133.", NoDecision (Goto 133)), ("If you wish to evade them, you must run across the open plain towards Ruanon-eight hundred yards away. Turn to 307.", NoDecision (Goto 307))]))])
    ),
    ( 201,
      Chapter
        "201"
    ...
    ( 202,
      Chapter
        ...
        (EvadeFight 0 342 (FightDetails {_opponent = "Guard 1", _fcombatSkill = CombatSkill {getCombatSkill = 18}, _fendurance = Endurance {getEndurance = 23}, _fightMod = []}) (Fight (FightDetails {_opponent = "Guard 2", _fcombatSkill = CombatSkill {getCombatSkill = 15}, _fendurance = Endurance {getEndurance = 24}, _fightMod = []}) (Fight (FightDetails {_opponent = "Guard 3", _fcombatSkill = CombatSkill {getCombatSkill = 15}, _fendurance = Endurance {getEndurance = 21}, _fightMod = []}) (Fight (FightDetails {_opponent = "Guard 4", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 25}, _fightMod = []}) (Fight (FightDetails {_opponent = "Guard 5", _fcombatSkill = CombatSkill {getCombatSkill = 14}, _fendurance = Endurance {getEndurance = 24}, _fightMod = []}) (Fight (FightDetails {_opponent = "Guard 6", _fcombatSkill = CombatSkill {getCombatSkill = 14}, _fendurance = Endurance {getEndurance = 22}, _fightMod = []}) (Goto 237)))))))
    ),
    ( 203,
      Chapter
        "203"
        ...
        (Decisions [("If you wish to fight them, turn to 108.", NoDecision (Goto 108)), ("If you wish to escape across the bridge, turn to 271.", NoDecision (Goto 271))])
    ),
    ( 204,
      Chapter
        "204"
        ...
        (NoDecision (Simple [MustEat Hunt] (Goto 142)))
    ),
    ( 205,
      Chapter
        "205"
    ...
    ( 206,
      Chapter
        ...
        (Decisions [("If you wish to enter the valley by the highway, turn to 82.", NoDecision (Goto 82)), ("If you wish to enter the valley under the cover of the forest, turn to 226.", NoDecision (Goto 226))])
    ),
    ( 207,
      Chapter
        "207"
        ...
        (NoDecision (Conditionally [(COr (COr (COr (COr (COr (COr (COr (COr (COr (COr (HasDiscipline (WeaponSkill Dagger)) (HasDiscipline (WeaponSkill Spear))) (HasDiscipline (WeaponSkill Mace))) (HasDiscipline (WeaponSkill ShortSword))) (HasDiscipline (WeaponSkill Warhammer))) (HasDiscipline (WeaponSkill Sword))) (HasDiscipline (WeaponSkill Axe))) (HasDiscipline (WeaponSkill Quarterstaff))) (HasDiscipline (WeaponSkill BroadSword))) (HasDiscipline (WeaponSkill MagicSpear))) (HasDiscipline (WeaponSkill Sommerswerd)), Randomly [(3 % 10, Goto 336), (7 % 10, Goto 218)]), (Always True, Randomly [(1 % 2, Goto 336), (1 % 2, Goto 218)])]))
    ),
    ( 208,
      Chapter
        "208"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Tunnel Guard 1", _fcombatSkill = CombatSkill {getCombatSkill = 15}, _fendurance = Endurance {getEndurance = 25}, _fightMod = []}) (Fight (FightDetails {_opponent = "Tunnel Guard 2", _fcombatSkill = CombatSkill {getCombatSkill = 15}, _fendurance = Endurance {getEndurance = 24}, _fightMod = []}) (Fight (FightDetails {_opponent = "Tunnel Guard 3", _fcombatSkill = CombatSkill {getCombatSkill = 14}, _fendurance = Endurance {getEndurance = 22}, _fightMod = []}) (Goto 199)))))
    ),
    ( 209,
      Chapter
        "209"
        ...
        (NoDecision (Conditionally [(HasLevel Aspirant, Goto 111), (Always True, Goto 43)]))
    ),
    ( 210,
      Chapter
        "210"
        ...
        (Decisions [("If you wish to follow your instincts, turn to 67.", NoDecision (Goto 67)), ("If you wish to press on regardless of your instincts, you can investigate the tavern by turning to 132.", NoDecision (Goto 132)), ("If you wish to continue along the street, turn to 301.", NoDecision (Goto 301))])
    ),
    ( 211,
      Chapter
        "211"
        ...
        (NoDecision (Randomly [(1 % 2, Goto 51), (1 % 2, Goto 120)]))
    ),
    ( 212,
      Chapter
        "212"
        ...
        (Decisions [("If you have the Kai Discipline of Animal Kinship, turn to 41.", Conditional (HasDiscipline AnimalKinship) (NoDecision (Goto 41))), ("otherwise", Conditional (Not (HasDiscipline AnimalKinship)) (Decisions [("If you do not possess this skill, search for an exit from the chamber and turn to 276.", NoDecision (Goto 276))]))])
    ),
    ( 213,
      Chapter
        "213"
        ...
        (CanTake (GenBackpack (GenCounter 2)) 1 (CanTake (GenBackpack (GenCounter 1)) 1 (CanTake (GenBackpack (GenCounter 3)) 1 (CanTake (GenBackpack (GenCounter 4)) 1 (CanTake (Weapon Axe) 1 (NoDecision (Goto 180)))))))
    ),
    ( 214,
      Chapter
        "214"
        ...
        (Decisions [("If you wish to run along the tunnel to avoid the spores, turn to 46.", NoDecision (Goto 46)), ("If you decide to go back to the chamber and take the south tunnel, turn to 117.", NoDecision (Goto 117))])
    ),
    ( 215,
      Chapter
        "215"
        ...
        (Decisions [("If you wish to draw your weapon and attack Barraka, turn to 296.", NoDecision (Goto 296)), ("If you wish to distract his attention from the altar without attacking him, turn to 119.", NoDecision (Goto 119))])
    ),
    ( 216,
      Chapter
        "216"
        ...
        (Decisions [("If you wish to help the other ranger who is now being dragged from the boat by his foot, turn to 304.", NoDecision (Goto 304)), ("If you wish to grab the oars and row for the other side of the river, turn to 189.", NoDecision (Goto 189))])
    ),
    ( 217,
      Chapter
        "217"
    ...
    ( 219,
      Chapter
        ...
        (Decisions [("If you wish to examine the wagon, turn to 167.", NoDecision (Goto 167)), ("If you wish to ignore the wagon, begin to climb the steep tunnel by turning to 185.", NoDecision (Goto 185))])
    ),
    ( 220,
      Chapter
        "220"
        ...
        (Decisions [("If you wish to fight the warrior, turn to 90.", NoDecision (Goto 90)), ("If you wish to evade combat, turn to 163.", NoDecision (Goto 163))])
    ),
    ( 221,
      Chapter
        "221"
        ...
        (Decisions [("If you wish to draw your weapon and prepare for combat, turn to 50.", NoDecision (Goto 50)), ("If you wish to flee from the bridge, run back along the tunnel and descend the stairs by turning to 228.", NoDecision (Goto 228)), ("If you would rather leap from the parapet of the bridge into the unknown depths of the chasm, turn to 342.", NoDecision (Goto 342))])
    ),
    ( 222,
      Chapter
        "222"
        ...
        (CanTake (Weapon Sword) 1 (NoDecision (Goto 165)))
    ),
    ( 223,
      Chapter
        "223"
        ...
        (Decisions [("If you wish to fight the warrior, turn to 77.", NoDecision (Goto 77)), ("If you wish to evade combat, turn to 128.", NoDecision (Goto 128))])
    ),
    ( 224,
      Chapter
        "224"
        "You can hear the harsh breath of the guards close behind you. Suddenly, the tunnel narrows and divides in two.\n"
        (Decisions [("If you possess either the Kai Discipline of Tracking or Sixth Sense, turn to 60.", Conditional (COr (HasDiscipline Tracking) (HasDiscipline SixthSense)) (NoDecision (Goto 60))), ("If you wish to enter the left tunnel, turn to 199.", NoDecision (Goto 199)), ("If you wish to enter the right tunnel, turn to 208.", NoDecision (Goto 208))])
    ),
    ( 225,
      Chapter
        "225"
        ...
        (NoDecision (Randomly [(1 % 2, Goto 20), (2 % 5, Goto 300), (1 % 10, Goto 181)]))
    ),
    ( 226,
      Chapter
        "226"
        ...
        (Decisions [("If you wish to continue making slow progress through the forest, turn to 21.", NoDecision (Goto 21)), ("If you decide to forsake the forest and press on along the highway instead, turn to 82.", NoDecision (Goto 82))])
    ),
    ( 227,
      Chapter
        "227"
        ...
        (Decisions [("If you decide to take a closer look at what they are eating, turn to 328.", NoDecision (Goto 328)), ("If you would rather ignore them and continue your ride, turn to 120.", NoDecision (Goto 120))])
    ),
    ( 228,
      Chapter
        "228"
        ...
        (Decisions [("If you wish to enter the hall and advance towards the door, turn to 23.", NoDecision (Goto 23)), ("If you wish to make for the stairs, turn to 105.", NoDecision (Goto 105))])
    ),
    ( 229,
      Chapter
        "229"
    ...
    ( 230,
      Chapter
        ...
        (CanTake Gold 9 (CanTake Meal 2 (CanTake (Weapon Sword) 1 (CanTake (Weapon Dagger) 1 (NoDecision (Goto 224))))))
    ),
    ( 231,
      Chapter
        "231"
        ...
        (CanTake Gold 3 (CanTake Meal 1 (CanTake (Weapon Sword) 1 (NoDecision (Goto 348)))))
    ),
    ( 232,
      Chapter
        "232"
        ...
        (Decisions [("If you wish to investigate the boathouse, turn to 68.", NoDecision (Goto 68)), ("If you wish to continue downstream and look for some other way to cross the river, turn to 130.", NoDecision (Goto 130))])
    ),
    ( 233,
      Chapter
        "233"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 17}, _fendurance = Endurance {getEndurance = 26}, _fightMod = []}) (Goto 312)))
    ),
    ( 234,
      Chapter
        "234"
    ...
    ( 235,
      Chapter
        ...
        (Decisions [("If you wish to investigate the torchlit cavern, turn to 177.", NoDecision (Goto 177)), ("If you wish to take a look over the low balcony, turn to 100.", NoDecision (Goto 100))])
    ),
    ( 236,
      Chapter
        "236"
        ...
        (Decisions [("If you wish to run straight into the forest, turn to 123.", NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 4})] (Goto 123))), ("If you want to change direction as soon as you are hidden from sight, turn to 169.", NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 4})] (Goto 169)))])
    ),
    ( 237,
      Chapter
        "237"
    ...
    ( 240,
      Chapter
        ...
        (NoDecision (Randomly [(1 % 2, Goto 94), (1 % 2, Goto 158)]))
    ),
    ( 241,
      Chapter
        "241"
        ...
        (Decisions [("If you wish to row across to the other bank, abandon the boat and continue on foot, turn to 343.", NoDecision (Goto 343)), ("If you wish to continue by river, turn to 115.", NoDecision (Goto 115))])
    ),
    ( 242,
      Chapter
        "242"
    ...
    ( 244,
      Chapter
        ...
        (Decisions [("If you have the Kai Discipline of Sixth Sense or Tracking, turn to 250.", Conditional (COr (HasDiscipline SixthSense) (HasDiscipline Tracking)) (NoDecision (Goto 250))), ("otherwise", Conditional (Not (COr (HasDiscipline SixthSense) (HasDiscipline Tracking))) (Decisions [("If you do not possess either of these skills, you may enter the left tunnel by turning to 335.", NoDecision (Goto 335)), ("Or, if you wish, you may enter the right tunnel by turning to 11.", NoDecision (Goto 11))]))])
    ),
    ( 245,
      Chapter
        "245"
        ...
        (Decisions [("If you wish to escape from the chamber by ascending the stairs, turn to 346.", NoDecision (Goto 346)), ("If you wish to leave by descending the stairs, turn to 83.", NoDecision (Goto 83))])
    ),
    ( 246,
      Chapter
        "246"
    ...
    ( 249,
      Chapter
        ...
        (NoDecision (Conditionally [(COr (COr (COr (COr (COr (COr (COr (COr (COr (COr (HasDiscipline (WeaponSkill Dagger)) (HasDiscipline (WeaponSkill Spear))) (HasDiscipline (WeaponSkill Mace))) (HasDiscipline (WeaponSkill ShortSword))) (HasDiscipline (WeaponSkill Warhammer))) (HasDiscipline (WeaponSkill Sword))) (HasDiscipline (WeaponSkill Axe))) (HasDiscipline (WeaponSkill Quarterstaff))) (HasDiscipline (WeaponSkill BroadSword))) (HasDiscipline (WeaponSkill MagicSpear))) (HasDiscipline (WeaponSkill Sommerswerd)), Randomly [(1 % 5, Goto 153), (2 % 5, Goto 323), (2 % 5, Goto 39)]), (Always True, Randomly [(2 % 5, Goto 153), (2 % 5, Goto 323), (1 % 5, Goto 39)])]))
    ),
    ( 250,
      Chapter
        "250"
    ...
    ( 251,
      Chapter
        ...
        (Decisions [("If you wish to search the highway ahead, turn to 175.", NoDecision (Goto 175)), ("If you wish to examine the burnt-out wagon, turn to 38.", NoDecision (Goto 38)), ("If you wish to explore the eastern track, turn to 293.", NoDecision (Goto 293))])
    ),
    ( 252,
      Chapter
        "252"
        ...
        (Decisions [("If you wish to investigate the boathouse, turn to 68.", NoDecision (Goto 68)), ("If you wish to continue downstream and look for some other way of crossing the river, turn to 130.", NoDecision (Goto 130))])
    ),
    ( 253,
      Chapter
        "253"
        ...
        (NoDecision (Conditionally [(HasLevel Warmarn, Goto 72), (Always True, Goto 135)]))
    ),
    ( 254,
      Chapter
        "254"
        ...
        (Decisions [("If you have the Kai Discipline of Tracking, turn to 326.", Conditional (HasDiscipline Tracking) (NoDecision (Goto 326))), ("otherwise", Conditional (Not (HasDiscipline Tracking)) (Decisions [("If you do not possess this skill, you may enter the east tunnel by turning to 156.", NoDecision (Goto 156)), ("Alternatively you can enter the south tunnel by turning to 101.", NoDecision (Goto 101))]))])
    ),
    ( 255,
      Chapter
        "255"
    ...
    ( 257,
      Chapter
        ...
        (Decisions [("If you wish to examine the chest, turn to 302.", NoDecision (Goto 302)), ("If you wish to ignore it and investigate the door, turn to 131.", NoDecision (Goto 131))])
    ),
    ( 258,
      Chapter
        "258"
        ...
        (Decisions [("If you possess an Onyx Medallion, turn to 305.", Conditional (HasItem (GenSpecial (GenCounter 11)) 1) (NoDecision (Goto 305))), ("otherwise", Conditional (Not (HasItem (GenSpecial (GenCounter 11)) 1)) (Decisions [("If you have the Kai Discipline of Camouflage and you have reached the Kai Rank of Guardian or higher, turn to 49.", Conditional (CAnd (HasDiscipline Camouflage) (HasLevel Guardian)) (NoDecision (Goto 49))), ("otherwise", Conditional (Not (HasDiscipline Camouflage)) (Decisions [("If you do not have this Special Item or this Discipline and Kai Rank, dive into the tall crops and hide by turning to 159.", NoDecision (Goto 159))]))]))])
    ),
    ( 259,
      Chapter
        "259"
    ...
    ( 260,
      Chapter
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Vassagonian Warhounds", _fcombatSkill = CombatSkill {getCombatSkill = 18}, _fendurance = Endurance {getEndurance = 30}, _fightMod = []}) (Goto 311)))
    ),
    ( 261,
      Chapter
        "261"
    ...
    ( 263,
      Chapter
        ...
        (Decisions [("If you wish to press on through the trees towards the south, turn to 123.", NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 4})] (Goto 123))), ("If you wish to change direction and head west, turn to 169.", NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 4})] (Goto 169)))])
    ),
    ( 264,
      Chapter
        "264"
        ...
        (Decisions [("If you wish to follow the prints, turn to 134.", NoDecision (Goto 134)), ("If you wish to head in the opposite direction to the tracks, turn to 191.", NoDecision (Goto 191))])
    ),
    ( 265,
      Chapter
        "265"
    ...
    ( 267,
      Chapter
        "267"
        "A terrible pain racks your chest as you are thrown backwards by the force of the crossbow bolt. You claw at the unyielding shaft, catching a glimpse of the face of an enemy guard as he raises his sword to deliver the coup de gr\226ce.\nYour life and your mission end here.\n"
        (NoDecision GameLost)
    ),
    ( 268,
      Chapter
        ...
        (CanTake Gold 4 (CanTake Meal 2 (CanTake (Weapon Spear) 1 (CanTake (Weapon BroadSword) 1 (CanTake (GenSpecial (GenCounter 2)) 1 (CanTake (GenSpecial (GenCounter 0)) 1 (CanTake Laumspur 1 (Decisions [("If you wish to examine the iron door, turn to 118.", NoDecision (Goto 118)), ("If you wish to ascend the spiral stairs, turn to 170.", NoDecision (Goto 170)), ("If you wish to descend the spiral stairs, turn to 228.", NoDecision (Goto 228))]))))))))
    ),
    ( 269,
      Chapter
        "269"
        ...
        (NoDecision (Simple [MustEat NoHunt] (Goto 145)))
    ),
    ( 270,
      Chapter
        "270"
        ...
        (NoDecision (Conditionally [(CAnd (HasItem (GenBackpack (GenCounter 2)) 1) (HasItem (GenBackpack (GenCounter 1)) 1), Goto 29), (HasItem (GenSpecial (GenCounter 1)) 1, Goto 168), (Always True, Goto 361)]))
    ),
    ( 271,
      Chapter
        "271"
    ...
    ( 273,
      Chapter
        ...
        (Decisions [("If you wish to stop to question these travelling minstrels, turn to 37.", NoDecision (Goto 37)), ("If you wish to ignore them and let them pass, turn to 126.", NoDecision (Goto 126))])
    ),
    ( 274,
      Chapter
        "274"
        ...
        (Decisions [("If you possess a Flask of Holy Water, turn to 283.", Conditional (HasItem (GenBackpack (GenCounter 0)) 1) (NoDecision (Goto 283))), ("otherwise", Conditional (Not (HasItem (GenBackpack (GenCounter 0)) 1)) (Decisions [("If you do not possess this Special Item, turn to 325.", NoDecision (Goto 325))]))])
    ),
    ( 275,
      Chapter
        "275"
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 1})] (Goto 335)))
    ),
    ( 276,
      Chapter
        "276"
        ...
        (Decisions [("If you wish to stand and fight the Stoneworm, turn to 88.", NoDecision (Goto 88)), ("If you wish to escape from the chamber, you run back to the ladder and turn to 26.", NoDecision (Goto 26))])
    ),
    ( 277,
      Chapter
        "277"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Vassagonian Warhounds", _fcombatSkill = CombatSkill {getCombatSkill = 22}, _fendurance = Endurance {getEndurance = 35}, _fightMod = []}) (Goto 155)))
    ),
    ( 278,
      Chapter
        "278"
        ...
        (Decisions [("If you wish to press on through the trees towards the south, turn to 123.", NoDecision (Goto 123)), ("If you wish to change direction and head west, turn to 169.", NoDecision (Goto 169))])
    ),
    ( 279,
      Chapter
        "279"
    ...
    ( 283,
      Chapter
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 3})] (Goto 350)))
    ),
    ( 284,
      Chapter
        "284"
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 3})] (Goto 362)))
    ),
    ( 285,
      Chapter
        "285"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Guard", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 28}, _fightMod = []}) (Goto 71)))
    ),
    ( 286,
      Chapter
        "286"
    ...
    ( 287,
      Chapter
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 17}, _fendurance = Endurance {getEndurance = 27}, _fightMod = []}) (Goto 75)))
    ),
    ( 288,
      Chapter
        "288"
        ...
        (Decisions [("If you wish to climb the mound of earth and squeeze through the narrow gap between the top of the mound and the ceiling, turn to 254.", NoDecision (Goto 254)), ("If you decide to call off the search and return to the mine entrance, turn to 187.", NoDecision (Goto 187))])
    ),
    ( 289,
      Chapter
        "289"
        ...
        (Decisions [("If you have reached the Kai rank of Warmarn (you possess 8 Kai Disciplines), turn to 255.", Conditional (HasLevel Warmarn) (NoDecision (Goto 255))), ("If you wish to help the captain, turn to 5.", Conditional (Not (HasLevel Warmarn)) (NoDecision (Goto 5))), ("If you wish to rally the defenders before the enemy reach the barricade, turn to 86.", Conditional (Not (HasLevel Warmarn)) (NoDecision (Goto 86)))])
    ),
    ( 290,
      Chapter
        "290"
        ...
        (Decisions [("If you wish to signal your men to attack the robed strangers, turn to 44.", NoDecision (Goto 44)), ("If you wish to try to capture them alive, turn to 102.", NoDecision (Goto 102)), ("If you decide to sheathe your weapon and approach them, your hand extended in a gesture of friendship, turn to 78.", NoDecision (Goto 78))])
    ),
    ( 291,
      Chapter
        "291"
        "The passage leads to an iron-studded door. Placing your ear to the rough wood, you detect the sound of voices.\n"
        (Decisions [("If you have the Kai Discipline of Camouflage, turn to 172.", Conditional (HasDiscipline Camouflage) (NoDecision (Goto 172))), ("otherwise", Conditional (Not (HasDiscipline Camouflage)) (Decisions [("If you do not possess this skill, you can draw your weapon, open the door, and turn to 93.", NoDecision (Goto 93)), ("Alternatively you can retrace your steps back to the gallery and take the other exit by turning to 55.", NoDecision (Goto 55))]))])
    ),
    ( 292,
      Chapter
        "292"
        ...
        (Decisions [("If you wish to press on towards the south, turn to 123.", NoDecision (Goto 123)), ("If you want to change direction and head west, turn to 169.", NoDecision (Goto 169))])
    ),
    ( 293,
      Chapter
        "293"
        ...
        (Decisions [("If you have the Kai Discipline of Tracking, turn to 18.", Conditional (HasDiscipline Tracking) (NoDecision (Goto 18))), ("otherwise", Conditional (Not (HasDiscipline Tracking)) (Decisions [("If you do not possess this skill, turn to 150.", NoDecision (Goto 150))]))])
    ),
    ( 294,
      Chapter
        "294"
    ...
    ( 296,
      Chapter
        "296"
        ""
        (Decisions [("If you possess the Sommerswerd, turn to 122.", Conditional (HasItem (Weapon Sommerswerd) 1) (NoDecision (Goto 122))), ("otherwise", Conditional (Not (HasItem (Weapon Sommerswerd) 1)) (Decisions [("If you do not possess this Special Item, turn to 274.", NoDecision (Goto 274))]))])
    ),
    ( 297,
      Chapter
        "297"
        ...
        (Decisions [("If you wish to try to cross the river further upstream to the west, turn to 113.", NoDecision (Goto 113)), ("If you wish to try to cross the river downstream, to the east, turn to 252.", NoDecision (Goto 252))])
    ),
    ( 298,
      Chapter
        "298"
    ...
    ( 299,
      Chapter
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Bandit Leader", _fcombatSkill = CombatSkill {getCombatSkill = 19}, _fendurance = Endurance {getEndurance = 29}, _fightMod = []}) (Goto 121)))
    ),
    ( 300,
      Chapter
        "300"
    ...
    ( 303,
      Chapter
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 2})] (Goto 348)))
    ),
    ( 304,
      Chapter
        "304"
        ...
        (NoDecision (Randomly [(1 % 2, Goto 47), (1 % 2, Goto 234)]))
    ),
    ( 305,
      Chapter
        "305"
    ...
    ( 307,
      Chapter
        ...
        (Decisions [("If you wish to quicken your pace and try to outrun them, turn to 225.", NoDecision (Goto 225)), ("If you wish to stop and fight them, turn to 36.", NoDecision (Goto 36))])
    ),
    ( 308,
      Chapter
        "308"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Elix", _fcombatSkill = CombatSkill {getCombatSkill = 17}, _fendurance = Endurance {getEndurance = 30}, _fightMod = []}) (Goto 127)))
    ),
    ( 309,
      Chapter
        "309"
        ...
        (NoDecision (Conditionally [(HasDiscipline Camouflage, Randomly [(2 % 5, Goto 138), (3 % 5, Goto 244)]), (Always True, Randomly [(4 % 5, Goto 138), (1 % 5, Goto 244)])]))
    ),
    ( 310,
      Chapter
        "310"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Vassagonian Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 18}, _fendurance = Endurance {getEndurance = 25}, _fightMod = []}) (Goto 24)))
    ),
    ( 311,
      Chapter
        "311"
        ...
        (Decisions [("If you wish to attack the bandit warrior, turn to 90.", NoDecision (Goto 90)), ("If you wish to rally the Sommlending soldiers to repel the advancing spearmen, turn to 3.", NoDecision (Goto 3))])
    ),
    ( 312,
      Chapter
        "312"
    ...
    ( 314,
      Chapter
        ...
        (Decisions [("If you wish to enter the hut, turn to 53.", NoDecision (Goto 53)), ("If you do not wish to enter the hut, continue your mission by turning to 258.", NoDecision (Goto 258))])
    ),
    ( 315,
      Chapter
        "315"
        ...
        (Decisions [("If you possess the Kai Discipline of Tracking, turn to 48.", Conditional (HasDiscipline Tracking) (NoDecision (Goto 48))), ("otherwise", Conditional (Not (HasDiscipline Tracking)) (Decisions [("If you wish to go left, turn to 269.", NoDecision (Goto 269)), ("If you wish to go right, turn to 145.", NoDecision (Goto 145))]))])
    ),
    ( 316,
      Chapter
        "316"
        ...
        (EvadeFight 0 31 (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 26}, _fightMod = []}) (Goto 146))
    ),
    ( 317,
      Chapter
        "317"
    ...
    ( 318,
      Chapter
        ...
        (Decisions [("If you possess a Scroll, turn to 279.", Conditional (HasItem (GenSpecial (GenCounter 2)) 1) (NoDecision (Goto 279))), ("otherwise", Conditional (Not (HasItem (GenSpecial (GenCounter 2)) 1)) (Decisions [("If you do not possess a Scroll, turn to 57.", NoDecision (Goto 57))]))])
    ),
    ( 319,
      Chapter
        "319"
        ...
        (NoDecision (Randomly [(1 % 2, Goto 25), (1 % 2, Goto 171)]))
    ),
    ( 320,
      Chapter
        "320"
        ...
        (Decisions [("If you wish to search them, turn to 268.", NoDecision (Goto 268)), ("If you wish to question them, turn to 76.", NoDecision (Goto 76))])
    ),
    ( 321,
      Chapter
        "321"
    ...
    ( 322,
      Chapter
        ...
        (CanTake (GenBackpack (GenCounter 3)) 1 (CanTake (GenBackpack (GenCounter 4)) 1 (Decisions [("If you wish to take the west tunnel, turn to 54.", NoDecision (Simple [HealPlayer (Endurance {getEndurance = 2})] (Goto 54))), ("If you wish to take the south tunnel, turn to 129.", NoDecision (Simple [HealPlayer (Endurance {getEndurance = 2})] (Goto 129)))])))
    ),
    ( 323,
      Chapter
        "323"
    ...
    ( 324,
      Chapter
        ...
        (Decisions [("If you wish to use the front door, turn to 114.", NoDecision (Simple [MustEat Hunt] (Goto 114))), ("If you wish to jump from the first-floor window, turn to 196.", NoDecision (Simple [MustEat Hunt] (Goto 196)))])
    ),
    ( 325,
      Chapter
        "325"
        ...
        (NoDecision (Fight (FightDetails {_opponent = "Barraka", _fcombatSkill = CombatSkill {getCombatSkill = 25}, _fendurance = Endurance {getEndurance = 29}, _fightMod = [MindblastImmune]}) (Goto 350)))
    ),
    ( 326,
      Chapter
        "326"
    ...
    ( 327,
      Chapter
        ...
        (NoDecision (Simple [LoseItem (Weapon Sword) 1, ClearFlag Special01] (Goto 289)))
    ),
    ( 328,
      Chapter
        "328"
    ...
    ( 330,
      Chapter
        ...
        (Decisions [("If you wish to search the wrecked wagon, turn to 38.", NoDecision (Goto 38)), ("If you wish to ignore the wagon and press on along the highway, turn to 175.", NoDecision (Goto 175)), ("If you wish to investigate the track that leads up into the hills, turn to 293.", NoDecision (Goto 293))])
    ),
    ( 331,
      Chapter
        "331"
        ...
        (Decisions [("If you have the Kai Discipline of Animal Kinship, turn to 41.", Conditional (HasDiscipline AnimalKinship) (NoDecision (Goto 41))), ("otherwise", Conditional (Not (HasDiscipline AnimalKinship)) (Decisions [("If you do not have this skill, you can search for an exit from the chamber and turn to 276.", NoDecision (Goto 276))]))])
    ),
    ( 332,
      Chapter
        "332"
    ...
    ( 333,
      Chapter
        ...
        (NoDecision (OneRound (FightDetails {_opponent = "Vassagonian Horseman", _fcombatSkill = CombatSkill {getCombatSkill = 20}, _fendurance = Endurance {getEndurance = 28}, _fightMod = []}) (Goto 209) (Goto 344) (Goto 220)))
    ),
    ( 334,
      Chapter
        "334"
    ...
    ( 335,
      Chapter
        ...
        (Decisions [("If you possess the Kai Discipline of Camouflage, turn to 35.", Conditional (HasDiscipline Camouflage) (NoDecision (Goto 35))), ("otherwise", Conditional (Not (HasDiscipline Camouflage)) (Decisions [("If you have the Kai Discipline of Mind Over Matter, turn to 317.", Conditional (HasDiscipline MindOverMatter) (NoDecision (Goto 317))), ("otherwise", Conditional (Not (HasDiscipline MindOverMatter)) (Decisions [("If you possess neither of the above Kai Disciplines, you will have to launch a surprise attack on the guard. Turn to 147.", NoDecision (Goto 147))]))]))])
    ),
    ( 336,
      Chapter
        "336"
    ...
    ( 340,
      Chapter
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 2})] (Goto 32)))
    ),
    ( 341,
      Chapter
        "341"
        ...
        (NoDecision (Simple [DamagePlayer (Endurance {getEndurance = 4})] (Goto 116)))
    ),
    ( 342,
      Chapter
        "342"
    ...
    ( 343,
      Chapter
        ...
        (NoDecision (Conditionally [(HasEndurance (Endurance {getEndurance = 20}), Randomly [(2 % 5, Goto 194), (3 % 5, Goto 61)]), (HasEndurance (Endurance {getEndurance = 12}), Randomly [(7 % 10, Goto 194), (3 % 10, Goto 61)]), (Always True, Randomly [(9 % 10, Goto 194), (1 % 10, Goto 61)])]))
    ),
    ( 344,
      Chapter
        "344"
    ...
    ( 345,
      Chapter
        ...
        (NoDecision (Randomly [(7 % 10, Goto 51), (3 % 10, Goto 120)]))
    ),
    ( 346,
      Chapter
        "346"
    ...
    ( 360,
      Chapter
        "143b"
        "Second fight"
        (Decisions [("evade", NoDecision (Goto 87)), ("fight", NoDecision (Fight (FightDetails {_opponent = "Tunnel Guard 2", _fcombatSkill = CombatSkill {getCombatSkill = 15}, _fendurance = Endurance {getEndurance = 21}, _fightMod = []}) (Goto 230)))])
    ),
    ( 361,
      Chapter
        "270b"
        "Choice"
        (Decisions [("way forward", NoDecision (Goto 246)), ("crypt door", NoDecision (Goto 183))])
    ),
    ( 362,
      Chapter
        "284b"
        "Choice"
        (EvadeFight 0 89 (FightDetails {_opponent = "Bandit Warrior", _fcombatSkill = CombatSkill {getCombatSkill = 16}, _fendurance = Endurance {getEndurance = 25}, _fightMod = []}) (Goto 7))
    )
  ]